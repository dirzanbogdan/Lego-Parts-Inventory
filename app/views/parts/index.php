    ...
    <div class="col-md-3 mb-4">
        <div class="card h-100">
            <div class="text-center p-3">
                <img src="<?= htmlspecialchars($part->img_url ?? $part->image_url ?? '/images/no-image.png') ?>" class="card-img-top part-img" alt="<?= htmlspecialchars($part->name) ?>" style="max-height: 150px; width: auto;" onerror="this.src='/images/no-image.png'">
            </div>
            <div class="card-body">
