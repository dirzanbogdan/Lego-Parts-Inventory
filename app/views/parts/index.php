    ...
    <div class="col-md-3 mb-4">
        <div class="card h-100">
            <div class="text-center p-3">
                <img src="<?= htmlspecialchars($part->image_url ?? '') ?>" class="card-img-top part-img" alt="<?= htmlspecialchars($part->name) ?>" style="max-height: 150px; width: auto;" onerror="this.style.display='none'">
            </div>
            <div class="card-body">
