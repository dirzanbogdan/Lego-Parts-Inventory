...
<form method="post" action="/admin/config/seed_colors">
  ...
  <p>Culori standard din Rebrickable (downloads/colors.csv).</p>
</form>
<h3>Importa piese</h3>
<form method="post" action="/admin/config/scrape_parts" id="form-parts">
  <input type="hidden" name="csrf" value="<?php echo htmlspecialchars($csrf); ?>">
  <textarea name="codes" placeholder="Listeaza codurile Rebrickable pe linii separate (ex: 3001)"></textarea>
...
<form method="post" action="/admin/config/scrape_sets" id="form-sets">
  <input type="hidden" name="csrf" value="<?php echo htmlspecialchars($csrf); ?>">
  <textarea name="codes" placeholder="Listeaza codurile Rebrickable pe linii separate (ex: 42065-1)"></textarea>
