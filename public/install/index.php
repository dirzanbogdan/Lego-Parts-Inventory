...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    $seedParts = isset($_POST['seed_parts']);
    $seedSets = isset($_POST['seed_sets']);
...
<div class="container">
  ...
  <form method="post">
    ...
    <label><input type="checkbox" name="seed_parts" value="1"> Seed piese sample</label>
    <label><input type="checkbox" name="seed_sets" value="1"> Seed seturi sample</label>
